...
QtObject {
    ...
    readonly property color onPrimary: "#{{colors.on_primary.default.hex_stripped}}"
    readonly property color primaryContainer: "#{{colors.primary_container.default.hex_stripped}}"
    readonly property color onPrimaryContainer: "#{{colors.on_primary_container.default.hex_stripped}}"
    
    readonly property color secondary: "#{{colors.secondary.default.hex_stripped}}"
    readonly property color onSecondary: "#{{colors.on_secondary.default.hex_stripped}}"
    readonly property color secondaryContainer: "#{{colors.secondary_container.default.hex_stripped}}"
    readonly property color onSecondaryContainer: "#{{colors.on_secondary_container.default.hex_stripped}}"

    readonly property color tertiary: "#{{colors.tertiary.default.hex_stripped}}"
    readonly property color onTertiary: "#{{colors.on_tertiary.default.hex_stripped}}"
    ...
    readonly property color onError: "#{{colors.on_error.default.hex_stripped}}"
