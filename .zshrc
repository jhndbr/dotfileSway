...
# Dotfiles & Scripts
if [ -d "$HOME/Documents/dotfileSway" ]; then
    ...
    alias dotfiles='cd ~/dotfileSway'
    alias dots-apply='bash ~/dotfileSway/setup.sh'
fi
...
if [ -x "$HOME/Aplicaciones/Antigravity/Antigravity-x64/antigravity" ]; then
    alias anti='~/Aplicaciones/Antigravity/Antigravity-x64/antigravity'
elif [ -x "$HOME/Aplicaciones/Antigravity-x64/antigravity" ]; then
